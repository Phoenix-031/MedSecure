...
contract RealEstate {
 ...
 //Events for properties
    ...
    event PropertySold(uint256 indexed id, address indexed oldOwner, address indexed newOwner, uint price);
    event PropertyResold(uint256 indexed id, address indexed oldOwner, address indexed newOwner, uint price);
    
 //Functions for properties

    function listPreoperty(address owner, uint256 price, string memory _propertyTitle, string memory _catagory, string memory _image, string memory _propertyAddress, string memory _description) external returns (uint256) {
    ...
    function updatePreoperty(address owner, uint256 productId,uint256 price, string memory _propertyTitle, string memory _catagory, string memory _image, string memory _propertyAddress, string memory _description) external returns (string memory) {
        Property storage property = properties[productId];
    ...
    function buyPreoperty(uint256 id, address buyer) external payable {
    ...
    function getPreoperty(uint256 id) external view returns(uint256, address, uint256, string memory, string memory, string memory, string memory, string memory) {
 ...
 //Events for reviews
    ...
    event ReviewLiked(uint256 indexed productId, uint256 reviewIndex, address indexed liker, uint256 likes);
